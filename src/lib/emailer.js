                             ...
                             <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                                <tr>
                                   <td style="padding:0 0 36px 0;color:#153643;">
                                      <h1 style="font-size:24px;margin:0 0 20px 0;font-family:Arial,sans-serif;">Hola Dr. ${user.username} Bienvenido a MedicalSignal</h1>
                                      <p
                                         style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                                         Le informamos que apartir de este momento se encuentra registrado para ser parte de nuestro equipos de medicos.
                                         <p>Donde podra realizar: </p>
                                      ...
                                      <table role="presentation"
                                         ...
                                         <tr>
                                            <td style="width:260px;padding:0;vertical-align:top;color:#153643;">
                                               ...
                                               <h1 style="font-size:14px;margin:0 0 20px 0;font-family:Arial,sans-serif;">Registro de Historial Clinico</h1>
                                               <p
                                                  style="margin:0 0 25px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                                                  <img src="https://i.ibb.co/K5rynvR/historial-medico.png" alt="" width="200"
                                            ...
                                            <td style="width:260px;padding:0;vertical-align:top;color:#153643;">
                                               ...
                                               <h1 style="font-size:14px;margin:0 0 20px 0;font-family:Arial,sans-serif;">Visualizacion de Señales fisiologicas</h1>
                                               <p
                                                  style="margin:0 0 25px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                                                  <img src="https://i.ibb.co/L1MfnW3/signos-vitales.png" alt="" width="200"
                                                     style="height:auto;display:block;" /></p>
